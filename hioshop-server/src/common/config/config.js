...
module.exports = {
   ...
   mianexpress:{
    ...
    qiniu: {
        access_key: 'oe55S664Ej0GulODxVEPc0cQkczybg96mmXoEQIb',      // 在七牛密钥管理中获取
        secret_key: '2ZTzyTDWjRyZFvj8XTRmh-l62_SkgzXb2lmeoYA1',    // 在七牛密钥管理中获取
        bucket: 'shundaimg',                    // 请填自己的bucket的名称
        domain: 'http://qnwmyprcs.hn-bkt.clouddn.com/'                         // 请填自己的domain域名
    },
    // 在七牛新建一个https的空间，这个是用来存储分享图片的https图片，对应的是goods表中的https_pic_url
    qiniuHttps: {
        access_key: 'oe55S664Ej0GulODxVEPc0cQkczybg96mmXoEQIb', // 在七牛密钥管理中获取
        secret_key: '2ZTzyTDWjRyZFvj8XTRmh-l62_SkgzXb2lmeoYA1', // 在七牛密钥管理中获取
        bucket: 'shundaimg', // 自己设置的
        domain: 'http://qnwmyprcs.hn-bkt.clouddn.com/', // 自己设置，例如：'http://img.你的域名.com/',别忘了这个”/“
